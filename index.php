...
<body class="bg-gradient-to-br from-base-200 to-base-300">
                        ...
                        <div class="card-body p-4">
                            <header class="flex items-center justify-between mb-4">
                                <div class="flex items-center space-x-3">
                                    <img src="<?= $timepoint_icon ?>" alt="TimePoint Zeiterfassung Logo" class="w-10 h-10">
    ...
    <script>
        ...
        function attachEventListeners() {
            document.querySelectorAll('.manual-time-record-form').forEach(form => {
        ...
        function exportToPDFA() {
            window.location.href = 'export_pdf.php?pdfa=1';
        }
    </script>
</body>
