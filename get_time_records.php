...
echo '<div class="flex justify-between items-center mb-4">
    ...
    <div class="flex gap-2">
        ...
        <button onclick="exportToPDF()" 
                class="btn btn-outline btn-error btn-sm gap-2 hover:scale-105 transform transition-transform duration-200" 
                >
            <i class="fas fa-file-pdf text-lg"></i>
            <span class="hidden sm:inline">PDF Export</span>
        </button>
        <button onclick="exportToPDFA()" 
                class="btn btn-error btn-sm gap-2 hover:scale-105 transform transition-transform duration-200" 
                >
            <i class="fas fa-file-pdf text-lg"></i>
            <span class="hidden sm:inline">PDF/A Export</span>
        </button>
    </div>
</div>';
