        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            <section class="card bg-base-100 shadow-xl xl:col-span-1">
                <div class="card-body">
                    ...
                    <h2 class="text-xl font-semibold"><?= ABOUT_DEVELOPER_INFO ?></h2>
                    <div class="space-y-2">
                        <p><strong><?= ABOUT_DEVELOPER ?>:</strong> Marek Tonino</p>
                        <p><strong><?= ABOUT_PROJECT ?>:</strong> <?= ABOUT_PROJECT_NAME ?></p>
                        <p><strong><?= ABOUT_TECHNOLOGY ?>:</strong> PHP, SQLite, Tailwind CSS, DaisyUI</p>
                    </div>
                </div>
            </section>
                ...
                <div class="card-body">
                    ...
                    <?php else : ?>
                        <div class="alert alert-info">
                            ...
                            <span><?= CHANGELOG_URL_MISSING ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </section>
